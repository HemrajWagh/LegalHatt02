...
html {
    ...
    <!--                     <button class="navbar-toggler " type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="row">
            <div class="container" style="display: flex; box-shadow: ; ">
                    ...
                    <div class="grid">
                       <div class="gc gc--1-of-3">
                        <div class="menu " style="">
                            <div><span class="light"></span><span>What is ISO</span></div>
                            <div><span class="light"></span><span>Benefits Of ISO</span></div>
                            <div><span class="light"></span><span>Advantages of ISO</span></div>
                    ...
                    <ul class="nacc">
                        <li class="active" id="topic1">
                            <div id="topic1">
                                <p>ISO (International Organization for Standardization) is the world's
                                    ...
                                    they help to break down barriers to international trade.
                                </p>
                                <p>    
                                 The ISO 9000 standards cover an organisation's practices in
                                 fulfilling the customer's quality requirstrongents and applicable
                                 regulatory requirstrongents while aiming to enhance customer
                                 satisfaction and achieve continual improvstrongent of its
                     ...
                     <li id="topic2">
                        <div id="topic2">
                            ...
                            <p>   Common, understanding system including consistent and repeatable processes requisite for better establishment.
                            </p>     
                            <p>
                             Furthermore, registration establishes yOur exclusive nights to use that trade mark for your goods or services.
                         </p>   
                         <p>Fewer failures in terms of quality of service or product</p>       
                         <p>Clarity for the people about what to do and how; less time spending on 'making things up' or 'finding things out' or reinventing wheels</p><br>       
                         <p>Better and more business opportunities as you can explore new
                            markets or having the certificate distinguishes you in the
                        marketplace.</p>     
                        <p>Establishment of new process and resources and skills to identify
                        & fix the problems in faster, better and cheaper way.</p>        
                        <p>Better management control and reporting</p>        
                        <p>You don't scratch your head wondering how to respond to tenders
                            or other questions asking about your quality system, because you
                        know! (And that 'ISO 9001' cachet works wonders.)</p>        

                    </div>
                </li>
                <li id="topic3">
                    <div>
                       <p>Organisation consistently report many benefits from gaining ISO 9001 which include:
                        <p>Greater management control</p>

                        <p>Greater clarity about what they do and how</p>

                        <p>Improvements in customer satisfaction</p>

                        <p>Increased employee satisfaction</p>
                        <p>Reduced rework and frustration</p>
